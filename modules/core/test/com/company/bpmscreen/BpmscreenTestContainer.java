...
public class BpmscreenTestContainer extends TestContainer {

    public BpmscreenTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "com/company/bpmscreen/app.properties",
    ...
    public static class Common extends BpmscreenTestContainer {

        public static final BpmscreenTestContainer.Common INSTANCE = new BpmscreenTestContainer.Common();
